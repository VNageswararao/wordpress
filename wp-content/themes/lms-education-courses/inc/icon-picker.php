...
class LMS_Education_Courses_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'lms-education-courses' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $lms_education_courses_font_awesome_icon_array = lms_education_courses_font_awesome_icon_array();
                    foreach ($lms_education_courses_font_awesome_icon_array as $lms_education_courses_font_awesome_icon) {
                            $icon_class = $this->value() == $lms_education_courses_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($lms_education_courses_font_awesome_icon).'"></i>
                            <span class="lms-education-courses-social-class">'.esc_attr($lms_education_courses_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function lms_education_courses_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'lms-education-courses-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'lms_education_courses_customizer_script' );

if(!function_exists('lms_education_courses_font_awesome_icon_array')){
    function lms_education_courses_font_awesome_icon_array(){
