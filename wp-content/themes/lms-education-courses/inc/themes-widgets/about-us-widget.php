...
class LMS_Education_Courses_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'LMS_Education_Courses_About_Widget',
			__('VW About us', 'lms-education-courses'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'lms-education-courses' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','lms-education-courses'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','lms-education-courses'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','lms-education-courses'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','lms-education-courses'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','lms-education-courses'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','lms-education-courses'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function lms_education_courses_about_custom_load_widget() {
	register_widget( 'LMS_Education_Courses_About_Widget' );
}
add_action( 'widgets_init', 'lms_education_courses_about_custom_load_widget' );