jQuery(document).ready(function($) {
    'use strict';
    var this_obj = lms_education_courses_plugin_activate_plugin;

    $('#gutenberg_editor .plugin-activation-redirect a').addClass('ive-redirect-to-dashboard');

    $(document).on('click', '.lms-education-courses-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message lms-education-courses-plugin-install');
                button.addClass('button-primary lms-education-courses-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.lms-education-courses-recommended-plugins .lms-education-courses-activation-note').css('display','block');
    ...
    $(document).on('click', '.lms-education-courses-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .lms-education-courses-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .lms-education-courses-recommended-plugins').css('display','none');
    });
