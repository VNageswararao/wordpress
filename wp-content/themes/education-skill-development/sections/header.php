		...
		<div class="row">
			<div class="col-lg-7 col-md-7 align-self-center text-center text-md-right">
				<?php if ( ! empty( $education_skill_development_header_phone_number ) ): ?>
					<span class="mr-4"><i class="fa fa-phone mr-3" aria-hidden="true"></i><?php echo esc_html( $education_skill_development_header_phone_number ); ?></span>
				<?php endif; ?>
				<?php if ( ! empty( $education_skill_development_header_email_address ) ): ?>
					<span><i class="fa fa-envelope mr-3" aria-hidden="true"></i><?php echo esc_html( $education_skill_development_header_email_address ); ?></span>
				<?php endif; ?>
			</div>
			<div class="col-lg-2 col-md-2 align-self-center text-center text-md-right">
				<div class="icons-media">
					<?php if ( ! empty( $education_skill_development_top_twitter_link ) ): ?>
						<a href="<?php echo esc_url( $education_skill_development_top_twitter_link ); ?>"><i class="fa fa-twitter mr-2" aria-hidden="true"></i>
						</a>
					<?php endif; ?>
					<?php if ( ! empty( $education_skill_development_top_linkdin_link ) ): ?>
						<a href="<?php echo esc_url( $education_skill_development_top_linkdin_link ); ?>"><i class="fa fa-linkedin mr-2" aria-hidden="true"></i>
						</a>
					<?php endif; ?>
					<?php if ( ! empty( $education_skill_development_top_youtube_link ) ): ?>
						<a href="<?php echo esc_url( $education_skill_development_top_youtube_link ); ?>"><i class="fa fa-youtube-play mr-2" aria-hidden="true"></i>
						</a>
					<?php endif; ?>
					<?php if ( ! empty( $education_skill_development_top_facebook_link ) ): ?>
						<a href="<?php echo esc_url( $education_skill_development_top_facebook_link ); ?>"><i class="fa fa-facebook mr-2" aria-hidden="true"></i>
						</a>
					<?php endif; ?>
					<?php if ( ! empty( $education_skill_development_top_instagram_link ) ): ?>
						<a href="<?php echo esc_url( $education_skill_development_top_instagram_link ); ?>"><i class="fa fa-instagram mr-2" aria-hidden="true"></i>
						</a>
					<?php endif; ?>
				</div>
			</div>
			<div class="col-lg-3 col-md-3 align-self-center text-center text-md-right">
		...
		<div class="row">
			...
			<div class="col-lg-2 col-md-2 align-self-center text-center text-md-right">
				<?php if ( ! empty( $education_skill_development_header_cart_link ) ): ?>
					<a class="lower-icons mr-4" href="<?php echo esc_url( $education_skill_development_header_cart_link ); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i>
					</a>
				<?php endif; ?>
