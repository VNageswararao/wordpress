                            ...
                            <span class="st-notification-column-wrapper">
                                ...
                                <span class="st-notification-column">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="https://wordpress.org/support/theme/education-skill-development/" target="_blank" class="button button-primary"><?php echo esc_html('Get Support','education-skill-development'); ?></a> </li>
                                    </ul>
                                </span>
                                <span class="st-notification-column">
                                    <h2><?php echo esc_html('Get More Options','education-skill-development'); ?></h2>
                                    <ul>
                                        <li><a href="https://mishkatwp.com/pro/education-skill-development/" target="_blank" class="button button-primary"><?php echo esc_html('View Live Demo','education-skill-development'); ?></a></li>
                                        <li><a href="https://www.mishkatwp.com/themes/skill-development-wordpress-theme/" class="button button-primary"><?php echo esc_html('Purchase Now','education-skill-development'); ?></a></li>
                                        <li><a href="https://mishkatwp.com/instruction/education-skill-development-free-docs/" target="_blank" class="button button-primary"><?php echo esc_html('Free Documentation','education-skill-development'); ?></a> </li>
                                    </ul>
                                </span>
                            </span>
                        </span>
