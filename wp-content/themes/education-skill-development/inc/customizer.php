...
if ( class_exists("Kirki")){
	...
	Kirki::add_field( 'theme_config_id', [
		...
		'default'     => '<a class="premium_info_btn" target="_blank" href="https://www.mishkatwp.com/themes/skill-development-wordpress-theme/">' . __( 'Buy Pro', 'education-skill-development' ) . '</a>',
        'type'        => 'custom',
        'priority'    => 100,
        'section'     => 'title_tagline',
    ] );
