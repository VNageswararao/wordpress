...
<!-- wp:group {"style":{"color":{"background":"#1630ae"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group has-background" style="background-color:#1630ae"><!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}}},"textColor":"background","className":"wow fadeInUp","fontSize":"medium","fontFamily":"saira"} -->
<p class="has-text-align-center wow fadeInUp has-background-color has-text-color has-link-color has-saira-font-family has-medium-font-size">'. esc_html('Education Blocks WordPress Theme By ','rt-education-school') .'  <a href="https://www.wpradiant.net/">'. esc_html('WP Radiant','rt-education-school') .'</a> | '. esc_html('Proudly powered by ','rt-education-school') .'  <a href="https://wordpress.org/">'. esc_html('WordPress','rt-education-school') .'</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->',
);