...
define('RT_EDUCATION_SCHOOL_BUY_NOW',__('https://www.wpradiant.net/blocks/school-wordpress-theme/','rt-education-school'));
define('RT_EDUCATION_SCHOOL_LIVE_DEMO',__('https://www.wpradiant.net/pattern/education-school-blocks/','rt-education-school'));
define('RT_EDUCATION_SCHOOL_PRO_DOC',__('https://www.wpradiant.net/tutorial/education-school-pro/','rt-education-school'));
	...
	<div class="rt-education-school-appearence wrap about-wrap">
		...
		<div class="four-col">
			...
			<div class="col">
				...
				<h3><i class="dashicons dashicons-cart"></i><?php esc_html_e( 'Upgrade to Pro', 'rt-education-school' ); ?></h3>

				<p>
					<?php esc_html_e( 'To gain access to extra theme options and more interesting features, upgrade to pro version.', 'rt-education-school' ); ?>
				</p>

				<p>
					<a class="button green button-primary" href="<?php echo esc_url( RT_EDUCATION_SCHOOL_BUY_NOW ); ?>" target="_blank"><?php esc_html_e( 'Upgrade to Pro', 'rt-education-school' ); ?></a>
				</p>
